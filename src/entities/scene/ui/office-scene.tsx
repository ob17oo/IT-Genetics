...
import {
  ...
  WALL_POSITION,
  WINDOW_POSITIONS,
} from "@/shared/config/office-scene-config";
...
const WallSticker = ({
  ...
  return (
    <mesh position={position} rotation={rotation}>
      ...
      <meshStandardMaterial map={texture} opacity={opacity} transparent />
    </mesh>
  );
};
        ...
        {TABLE_POSITIONS.map((table, i) => (
          <group key={i}>
            <TableObject
              ...
              scale={table.scale}
            />
            <CuboidCollider args={[8, 0.1, 2]} position={[-5.2, 0.8, 2.5]} />
          </group>
        ))}
      </>
    ),
    ...
    <section className="w-full h-screen relative">
      ...
      >
        <Suspense fallback={null}>
          <Physics gravity={[0, -20, 0]} timeStep={1 / 60} maxCcdSubsteps={1}>
            ...
            <RigidBody type="fixed" colliders={false}>
              ...
              <CuboidCollider
                args={[21.5, 0.05, 6.9]}
                position={[0, -1.05, -26.9]}
              />
            </RigidBody>
            <mesh position={[0, 9.5, -26.9]}>
              <boxGeometry args={[43, 0.1, 13.8]} />
              <meshStandardMaterial color="#D3D3D3" />
            </mesh>
            ...
            <RigidBody type="fixed">
              <ItemRender
                itemName="trashBucket"
                scale={0.35}
                position={[3.4, -0.9, 1 - 8.8]}
                rotation={[0, Math.PI / 2, 0]}
              />
            </RigidBody>

            <ItemRender
              itemName="SurpriseGlassWall"
              scale={[7, 8, 8]}
              position={[-17.5, -1, 12.4]}
              rotation={[0, Math.PI / -2, 0]}
            />
            <CuboidCollider
              args={[3.5, 3, 0.1]}
              position={[-17.5, 2, 15.9]}
              rotation={[0, Math.PI / 2, 0]}
            />

            <ItemRender
              itemName="ShockGlassWall"
              scale={[8.1, 8, 8]}
              position={[-17.5, -1, 2.75]}
              rotation={[0, Math.PI / -2, 0]}
            />
            <CuboidCollider
              args={[4.3, 3, 0.1]}
            ...
            <WallSticker
              ...
              rotation={[0, Math.PI / 2, 0]}
              args={[8, 8]}
              stickerURL="/textures/flashTexture.png"
              opacity={1}
            />
            ...
            <WallSticker
              position={[-17.2, 5.2, -2.5]}
              rotation={[Math.PI / -1.1, Math.PI / 2, 0]}
              args={[8, 8]}
              stickerURL="/textures/bubbleTexture.png"
              opacity={0.7}
            />

            <ItemRender
              itemName="DinnerGlassWall"
              scale={[6.57, 6.4, 8]}
              position={[17.6, -1, 16]}
              rotation={[0, Math.PI / 2, 0]}
            />
            ...
            <mesh position={[24.5, 9.5, 20.5]}>
              <boxGeometry args={[6, 0.1, 1]} />
              <meshStandardMaterial color="#D3D3D3" />
            </mesh>

            <OfficeDoorObject
              position={[-23.5, 1, 19.6]}
              rotation={[0, 0, 0]}
              scale={1}
            />
            <ItemRender
              itemName="MeetingTable"
              scale={7}
              rotation={[0, Math.PI / 2, 0]}
              position={[-24.5, -1, 14]}
            />
            ...
            <group>
              <ItemRender
                itemName="MeetingChair"
                scale={2.5}
                rotation={[0, Math.PI / -2, 0]}
                position={[-22.5, -0.9, 9.5]}
              />
              <ItemRender
                itemName="MeetingChair"
                scale={2.5}
              ...
              <ItemRender
                ...
                position={[-22.3, -0.9, -5.2]}
              />
            </group>

            <ItemRender
              itemName="MeetingSofa"
              scale={[5, 5, 7.4]}
              rotation={[0, Math.PI / 2, 0]}
              position={[-17.5, -1, 2.3]}
            />
            ...
            />
            <ItemRender
              itemName="FourFirecase"
              scale={[120, 120, 30]}
              position={[17.4, 0, -3.5]}
              rotation={[0, Math.PI / -2, 0]}
            />
            <ItemRender
              itemName="flower/flowerTall"
              scale={0.009}
              position={[16, -0.5, -0.3]}
              rotation={[0, 0, 0]}
            />
            <ItemRender
              itemName="flower/flowerPalm"
              scale={2}
              position={[16.4, -0.92, 5]}
              rotation={[0, 0, 0]}
            />
            <ItemRender
              itemName="flower/flowerRhyzome"
              scale={1.5}
              position={[16, -0.9, 7]}
              rotation={[0, 0, 0]}
            />
            ...
            <group>
              <ItemRender
                itemName="DinnerChair"
                scale={[3.5, 3.3, 3.5]}
                position={[22.5, 0.1, 18.7]}
                rotation={[0, Math.PI / -1.6, 0]}
              />
              <ItemRender
                itemName="DinnerChair"
                scale={[3.5, 3.3, 3.5]}
                position={[24.5, 0.1, 18.7]}
                rotation={[0, Math.PI / -1.6, 0]}
              />
              <ItemRender
                itemName="DinnerChair"
                scale={[3.5, 3.3, 3.5]}
                position={[26.5, 0.1, 18.7]}
                rotation={[0, Math.PI / -1.6, 0]}
              />
              ...
              <ItemRender
                itemName="DinnerChair"
                scale={[3.5, 3.3, 3.5]}
                position={[22.5, 0.1, 15]}
                rotation={[0, Math.PI / 2.4, 0]}
              />
              <ItemRender
                itemName="DinnerChair"
                scale={[3.5, 3.3, 3.5]}
                position={[24.5, 0.1, 15]}
                rotation={[0, Math.PI / 2.4, 0]}
              />
              <ItemRender
                itemName="DinnerChair"
                scale={[3.5, 3.3, 3.5]}
                position={[26.5, 0.1, 15]}
                rotation={[0, Math.PI / 2.4, 0]}
              />
              ...
              <ItemRender
                itemName="DinnerChair"
                scale={[3.5, 3.3, 3.5]}
                position={[20.3, 0.1, 17]}
                rotation={[0, Math.PI / 1.15, 0]}
              />

              <RoundedBox
                args={[1, 6.8, 0.15]}
                position={[31.6, 1.5, 15.5]}
                radius={0.1}
                smoothness={4}
              ...
              <ItemRender
                scale={[4, 4.2, 4.3]}
                itemName="DinnerWindow"
                position={[31.8, 1.5, 15.5]}
                rotation={[0, Math.PI / 1, 0]}
              />
              <ItemRender
                itemName="Radiator"
                scale={[2, 2, 2]}
                rotation={[0, Math.PI / -2, 0]}
                position={[31.2, -0.6, 15.5]}
              />
              <ItemRender
                itemName="waterStand"
                scale={[1.5, 1.5, 1.5]}
                rotation={[0, Math.PI / -1.5, 0]}
                position={[31, -0.85, 10.8]}
              />
            </group>

            <group>
              <ItemRender
                itemName="Hexagon-Yellow"
                scale={[30, 30, 30]}
                position={[28.5, 2, 8.5]}
                rotation={[Math.PI / 2, 0, Math.PI / 2]}
              />
              <ItemRender
                itemName="Hexagon-Black"
                scale={[22, 22, 22]}
                position={[28.5, 1.3, 6.95]}
                rotation={[Math.PI / 2, 0, Math.PI / 2]}
              />
              <ItemRender
                itemName="Hexagon-Yellow"
                scale={[30, 30, 30]}
                position={[28.5, 2, 5.45]}
                rotation={[Math.PI / 2, 0, Math.PI / 2]}
              />
              <ItemRender
                itemName="Hexagon-Yellow"
                scale={[19, 19, 19]}
                position={[28.5, 4, 6.95]}
                rotation={[Math.PI / 2, 0, Math.PI / 2]}
              />
              ...
              <ItemRender
                itemName="Hexagon-Black"
                scale={[30, 30, 30]}
                position={[26.2, 1.2, 21]}
                rotation={[Math.PI / -2, 0, 0]}
              />
              <ItemRender
                itemName="Hexagon-Yellow"
                scale={[30, 30, 30]}
                position={[24.4, 2.1, 21]}
                rotation={[Math.PI / -2, 0, 0]}
              />
            </group>

            <ItemRender
              itemName="DinnerBarTable"
              scale={[7, 6.5, 7]}
              rotation={[0, 0, 0]}
              position={[24.2, -1, 2]}
            />
            <group>
              <ItemRender
                itemName="DinnerBarChair-Black"
                scale={[1.7, 1.7, 1.7]}
                rotation={[0, Math.PI / 2, 0]}
                position={[23, 0.75, 8]}
              />
              <ItemRender
                itemName="DinnerBarChair-Yellow"
                scale={[1.7, 1.7, 1.7]}
                rotation={[0, Math.PI / 2, 0]}
                position={[23, 0.75, 6]}
              />
              ...
              <ItemRender
                ...
                scale={[1.7, 1.7, 1.7]}
                rotation={[0, Math.PI / -2, 0]}
                position={[26.5, 0.75, 8]}
              />
              <ItemRender
                itemName="DinnerBarChair-Yellow"
                scale={[1.7, 1.7, 1.7]}
                rotation={[0, Math.PI / -2, 0]}
                position={[26.5, 0.75, 6]}
              />
              <ItemRender
                itemName="DinnerBarChair-Black"
                scale={[1.7, 1.7, 1.7]}
                rotation={[0, Math.PI / -2, 0]}
                position={[26.5, 0.75, 4]}
              />
            </group>
            ...
            <mesh position={[23.75, 9.5, -26.9]}>
              <boxGeometry args={[4.5, 0.1, 13.8]} />
              <meshStandardMaterial color="#D3D3D3" />
            </mesh>

            <ItemRender
              itemName="WaterCooler"
              scale={0.3}
              position={[-17.5, -1, -17]}
              rotation={[0, Math.PI / -2, 0]}
            />
            ...
            <InstancedWindow
              instances={WINDOW_POSITIONS.map((window) => ({
            ...
            <mesh position={[46, 9.5, -28]}>
              <boxGeometry args={[43, 0.1, 23.9]} />
              <meshStandardMaterial color="#D3D3D3" />
            </mesh>

            <ItemRender
              itemName="OlegGlassWall"
              scale={[11.2, 11, 10]}
              rotation={[0, Math.PI / 1, 0]}
              position={[28.8, -1, -16.3]}
            />
            <CuboidCollider
              args={[5, 3, 0.1]}
              position={[31.1, 2, -16.3]}
              rotation={[0, 0, 0]}
            />
            ...
            <ItemRender
              ...
              scale={0.025}
              position={[27.5, -0.9, -25.7]}
              rotation={[0, Math.PI / 2, 0]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              position={[29.5, -0.9, -29.5]}
              rotation={[0, 0, 0]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              position={[32, -0.9, -25.7]}
              rotation={[0, Math.PI / -2, 0]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              position={[29.5, -0.9, -22.5]}
              rotation={[0, Math.PI / -1, 0]}
            />
            <ItemRender
              itemName="Egg-Chair"
            ...
            <ItemRender
              itemName="OrangeGlassWall"
              scale={[11, 11, 11]}
              rotation={[0, Math.PI / 1, 0]}
              position={[38.4, -1, -16.3]}
            />
            <CuboidCollider
              args={[9.5, 3, 0.1]}
              position={[46, 2, -16.3]}
            ...
            <ItemRender
              ...
              scale={2}
              rotation={[0, Math.PI / 1, 0]}
              position={[49.2, -0.9, -24]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              rotation={[0, Math.PI / 1, 0]}
              position={[46.5, -0.9, -24]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              rotation={[0, Math.PI / 1, 0]}
              position={[44.5, -0.9, -24]}
            />
            ...
            <ItemRender
              ...
              scale={2}
              rotation={[0, Math.PI / 2, 0]}
              position={[42.4, -0.9, -25]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              rotation={[0, Math.PI / 2, 0]}
              position={[42.4, -0.9, -27]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              rotation={[0, Math.PI / 2, 0]}
              position={[42.4, -0.9, -29]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              rotation={[0, Math.PI / 2, 0]}
              position={[42.4, -0.9, -31]}
            />
            ...
            <ItemRender
              ...
              scale={2}
              rotation={[0, 0, 0]}
              position={[49.2, -0.9, -32]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              rotation={[0, 0, 0]}
              position={[46.5, -0.9, -32]}
            />
            <ItemRender
              itemName="Office-Gray-Chair"
              scale={2}
              rotation={[0, 0, 0]}
              position={[44.5, -0.9, -32]}
            />
            ...
            <MissionIndicator
              ...
              playerPosition={playerPosition}
              missionId={1}
              missionPosition={[-3, 1.5, 15]}
              onInteract={(missionId) => setActiveMission({ missionId })}
            />
            <MissionIndicator
              key="mission-2"
              playerPosition={playerPosition}
              missionId={2}
              missionPosition={[-10, 1.5, 5]}
              onInteract={(missionId) => setActiveMission({ missionId })}
            />
            <MissionIndicator
              key="mission-3"
