                    ...
                    <section className="bg-[#121212] rounded-3xl border border-yellow-500/30 p-8 w-full max-w-4xl h-fit space-y-6">
                        <section className="flex items-start justify-between gap-4 border-b border-yellow-500/30 pb-4">
                            <div>
                                ...
                                <h2 className="text-3xl font-bold text-yellow-500">{npcName}</h2>
                        ...
                        <section className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                            {npcMission.length === 0 && (
                                <p className="text-yellow-100/70">Для этого персонажа нет активных заданий.</p>
                            )}
                                ...
                                return (
                                    ...
                                    >
                                        <header className="flex items-center justify-between gap-4">
                                            <div>
                                                <p className="text-xs uppercase tracking-[0.2em] text-yellow-500/70">{mission.type}</p>
                                                <h3 className="text-xl text-yellow-100 font-semibold">{mission.title}</h3>
                                            </div>
                                            <p className="text-yellow-500 font-semibold">+{mission.reward} XP</p>
                                        </header>
                                        <p className="text-yellow-100/70 text-sm leading-relaxed">{mission.description}</p>
